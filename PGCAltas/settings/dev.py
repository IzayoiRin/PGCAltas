"""
Django settings for PGCAltas project.
...
SECRET_KEY = 'opz3g67_i-%^*24qer%-%9f4xykqczsp316a5u8n7r@8)n^v77'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'PGCAltas/../templates')]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'PGCAltas.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {  # 日志处理方法
        ...
        'file': {  # 向文件中输出日志
            ...
            'filename': os.path.join(os.path.dirname(BASE_DIR), "logs/PGCAltas.log"),  # 日志文件的位置
...
REST_FRAMEWORK = {
    # Costume exception handler handling db and drf errors
    'EXCEPTION_HANDLER': 'PGCAltas.utils.exceptions.exception_handler',
}
