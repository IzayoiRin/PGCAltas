...
from pgc_torch.errors import ConfigError, ObjectTypeError, AnalysisError, ParametersError
...
class GenericFeedForwardNet(object):
    ...
    def get_optimizer(self):
        ...
        raise ConfigError('Config a legal model graph first')
    ...
    def eval(self):
        ...
        """
        te_dl = self.get_data_loader(False)
        with th.no_grad():
